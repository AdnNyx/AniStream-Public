    ...
    <div className="relative min-h-screen bg-neutral-900 text-white">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="md:flex mt-8">
          <div className="md:w-1/3 justify-center flex mb-6 md:mb-0 md:pr-8 shrink-0">
            <Image
              src={anime.poster}
              alt={anime.title}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {anime.episodes && anime.episodes.length > 0 ? (
            anime.episodes.map((episode) => (
              ...
              >
                <div className="w-24 h-12 bg-neutral-700 rounded flex items-center justify-center shrink-0">
